...
A relational database is a database made up of tables. SQL is what you use to interact with the database.

2. Why do tables need a `primary key`?

A primary key ensures row-level accessibility.
...
2 separate one-to-many tables, and a third "join" table that serves as the many-to-many table.
